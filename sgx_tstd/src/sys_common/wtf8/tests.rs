...
fn wtf8buf_truncate_fail_code_point_boundary() {
    let mut string = Wtf8Buf::from_str("aé");
    should_panic!(string.truncate(2));
}

#[test_case]
fn wtf8buf_truncate_fail_longer() {
    let mut string = Wtf8Buf::from_str("aé");
    should_panic!(string.truncate(4));
}
...
fn wtf8buf_truncate_splitting_non_bmp3() {
    let mut string = Wtf8Buf::from_str("💩");
    assert!(string.is_known_utf8);
    should_panic!(string.truncate(3));
}
...
fn wtf8buf_truncate_splitting_non_bmp1() {
    let mut string = Wtf8Buf::from_str("💩");
    assert!(string.is_known_utf8);
    should_panic!(string.truncate(1));
}
...
fn wtf8_slice_not_code_point_boundary() {
    should_panic!(&Wtf8::from_str("aé 💩")[2..4]);
}
...
fn wtf8_slice_from_not_code_point_boundary() {
    should_panic!(&Wtf8::from_str("aé 💩")[2..]);
}
...
fn wtf8_slice_to_not_code_point_boundary() {
    should_panic!(&Wtf8::from_str("aé 💩")[5..]);
}
