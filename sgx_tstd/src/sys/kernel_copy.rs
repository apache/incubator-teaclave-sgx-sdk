...
use crate::sys::cvt;
use sgx_libc::{EBADF, EINVAL, ENOSYS, EOPNOTSUPP, EOVERFLOW, EPERM, EXDEV};
...
pub(super) fn copy_regular_files(reader: RawFd, writer: RawFd, max_len: u64) -> CopyResult {
    ...
    match HAS_COPY_FILE_RANGE.load(Ordering::Relaxed) {
        NOT_PROBED => {
            ...
            let result = unsafe {
                cvt(libc::copy_file_range(INVALID_FD, ptr::null_mut(), INVALID_FD, ptr::null_mut(), 1, 0))
            };
    ...
    while written < max_len {
        ...
        let copy_result = unsafe {
            ...
            cvt(libc::copy_file_range(reader, ptr::null_mut(), writer, ptr::null_mut(), bytes_to_copy, 0))
        };
...
mod libc {
    pub use sgx_libc::ocall::{copy_file_range, sendfile, splice};
    pub use sgx_libc::*;
}
